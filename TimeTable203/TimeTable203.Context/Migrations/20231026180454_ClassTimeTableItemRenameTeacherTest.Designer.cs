...
namespace TimeTable203.Context.Migrations
{
    ...
    [Migration("20231026180454_ClassTimeTableItemRenameTeacherTest")]
    partial class ClassTimeTableItemRenameTeacherTest
    {
            ...
            modelBuilder.Entity("TimeTable203.Context.Contracts.Models.TimeTableItem", b =>
                {
                    ...
                    b.HasOne("TimeTable203.Context.Contracts.Models.Person", "Teacher")
                        .WithMany("TimeTableItem")
